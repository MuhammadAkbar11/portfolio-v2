...
function AboutContent({}: Props) {
  return (
    <section className=" bg-secondary h-screen relative flex flex-col w-full justify-start flex-1 pt-5 md:pt-8 lg:pt-5 pb-14 px-6 md:px-20 lg:px-32 mb-10 mt-8">
