...
function HeroActionRight({ href, name, cursorText }: Props) {
  ...
  return (
    <motion.a
      ...
      animate="open"
      whileTap={{ scale: 0.97 }}
      className="flex-1 overflow-hidden flex flex-col justify-center items-center px-6 sm:px-8 py-8 sm:py-16 md:py-8 relative hover:bg-light-secondary/10 transition-all duration-300 ease-out"
